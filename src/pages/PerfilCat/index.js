...
export default function PerfilCat({navigation}){


  const renderBlockPerfilCat = (nome) => {
    return(
      <>
        <SelectorBlock>
          {renderInfo()}
  ...
  const renderInfo = () => {
    ...
    <>
     <SelectorBlockDiv>
      <Image source={require("../../../assets/adotapet-cat-perfil.png")}/>
      </SelectorBlockDiv>
      <TextInputLabel>
        <Text>{"Nome:"}</Text>
      </TextInputLabel>
